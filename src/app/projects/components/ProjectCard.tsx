...
const ProjectCard = (props: Project) => {
    ...
    return (
        <MagicCard className="cursor-pointer rounded-lg dark:shadow-2xl w-[calc(50%-0.5rem)] max-lg:w-full max-sm:w-full h-[310px] border-none !bg-transparent" gradientColor={`${isDarkMode ? '#262626' : 'rgba(197, 241, 241, 0.4)'}`}>

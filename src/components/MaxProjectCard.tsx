...
const data: Project[] = [
    {
        ...
        techStack: ["NextJS", "TypeScript", "Prisma", "MongoDB", "NextAuth", "TipTap Editor", "Resend", "Cloudinary", "Zod", "framer-motion", "Radix UI", "Magic UI", "Tailwind CSS"],
        link: "https://varunsingh.dev/",
        source: "https://github.com/VarunSingh19/portfolio",
    }
];
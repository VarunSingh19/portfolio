        ...
        <div className='w-1/2 max-lg:w-full max-lg:px-20 max-sm:w-full max-sm:px-5 flex flex-col items-center mt-4 pb-8'>
...

            {
                educationData.map((edu: I_Education, idx) => (
                    <MagicCard key={idx} className="cursor-pointer dark:shadow-2xl mt-5 !bg-transparent border-none min-h-fit" gradientColor={`${isDarkMode ? '#262626' : 'rgba(197, 241, 241, 0.4)'}`}>
                        <div className="flex w-full px-5 max-sm:px-0 max-sm:pr-1 py-3">
                            ...
                            <div className="w-full">
                                ...
                                <div className="mt-3 max-sm:mt-2 text-sm max-sm:text-[11px] leading-relaxed">

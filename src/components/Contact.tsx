        ...
        <div className='w-full px-64 max-[1285px]:px-52 max-lg:px-4 max-sm:px-2 flex flex-col items-center mt-6 pb-8'>
            ...
            <div className={`w-full flex flex-col gap-3 mt-6 px-36 max-sm:px-4 ${bricolage_grotesque}`}>
                ...
                <div className='flex gap-3 mt-2'>
                    <Link href="https://cal.com/varunsingh09/15min" target="_blank">
                    ...
                    <Link href="https://github.com/VarunSingh19" target="_blank">
                        <button className='bg-[#333] text-white py-2 px-3 rounded-md flex items-center gap-2 text-sm max-sm:text-xs hover:bg-[#555]'>
                            <FaXTwitter className='h-[18px] w-[18px]' /> View GitHub
                        </button>
                    </Link>
                </div>
